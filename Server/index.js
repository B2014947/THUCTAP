...
const documentsOutgoingRouter = require('./router/documentsOutgoing'); // Import router for documents outgoing
const app = express();
...
app.use('/api', documentsOutgoingRouter); // Use router for documents outgoing
